/**
 * Nexus Files — Stroke Icon Registry
 * Abstract, lightweight 24x24 SVG icons matching application design system.
 */

export const ICONS = {
  folder: '<path d="M3 6.5A1.5 1.5 0 014.5 5H9l2 2h8.5A1.5 1.5 0 0121 8.5v10a1.5 1.5 0 01-1.5 1.5h-15A1.5 1.5 0 013 18.5v-12z"/>',
  file: '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/>',
  image: '<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>',
  video: '<rect x="2" y="4" width="20" height="16" rx="2"/><polygon points="10 9 16 12 10 15 10 9"/>',
  audio: '<path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/>',
  code: '<polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>',
  archive: '<path d="M21 8v13H3V8"/><path d="M1 3h22v5H1z"/><path d="M10 12h4"/>',
  pdf: '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M9 13h6"/><path d="M9 17h4"/>',
  ...
  sort: '<polyline points="7 10 12 15 17 10"/><polyline points="17 14 12 9 7 14"/>',
  ...
  folderPlus: '<path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/><line x1="12" y1="11" x2="12" y2="17"/><line x1="9" y1="14" x2="15" y2="14"/>',
  filePlus: '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/>',
  eye: '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>',
  chevronRightSm: '<polyline points="9 18 15 12 9 6"/>',
};
...
export function icon(pathD, className = '') {
...
export function getFileTypeCategory(ext) {
  ...
  const map = {
    ...
    code: ['js', 'ts', 'tsx', 'jsx', 'py', 'rs', 'go', 'c', 'cpp', 'h', 'java', 'html', 'css', 'json', 'xml', 'yaml', 'yml', 'toml', 'md', 'sh', 'bat', 'ps1', 'vue', 'svelte'],
...
/** Minimal stroke file icon element */
export function fileIconEl(file, extraClass = '') {
  const type = file.isDir ? 'folder' : getFileTypeCategory(file.extension);
  const path = FILE_TYPE_ICONS[type] || FILE_TYPE_ICONS.default;
  return icon(path, `file-icon ${type} ${extraClass}`.trim());
}
